      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">{{Auth::user()->usernames}}</span>
          </a><!-- End Profile Iamge Icon -->

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6>{{Auth::user()->usernames}}</h6>
              {{-- <span>Admin</span> --}}
            </li>
            <li>
              <hr class="dropdown-divider">
    ...
    <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link"  href="{{route('permissions.index')}}">
          <i class="bi bi-people"></i><span>Permission</span>
        </a>
      </li>
  </ul>
...
<main id="main" class="main">
    ...
    @role('staff')
    <h4 class="m-0"> Staff Dashboard</h4>
    @endrole

    <h4 class="m-0"> {{Auth::user()->name}} Dashboard</h4>
