<form class="row g-3">
    <div class="col-lg-12">
        <div class="row">
            <div class="col-lg-6">
                <div class="row">
                    <label for="role_name">Role name</label>
                        <input type="text" name="role_name" wire:model="role_name" class="form-control" id="role_name" placeholder="Role Name" value="{{ old('role_name') }}">
            ...
            <div class="col-lg-6">
                ...
                <div class="">
                    <label><input type="checkbox" wire:model="permission_id.{{ $permission->id }}" value="{{$permission->id}}"> {{$permission->name}}</label>
                </div>           
                @endforeach
    ...
    <div class="row pt-4">
        <div class="col-lg-12">
            <button class="btn btn-primary w-10" style="margin-left: 43%;" wire:click.prevent="rolestore">Create Role</button>
        </div>
    </div>
</form>